...
function FeedbackPage(): JSX.Element {
  return (
    <Page logo={false}>
      <HalfPage side="left" event="RST" year={2026}>
        <h2>Feedback</h2>
      ...
      <HalfPage side="right" event="RST" year={2026}>
        <div style="grid-row-start: 5;">
          ...
          <p class="line"></p>
          <p class="line">
            Wünsche für die nächsten Rollenspieltage,{" "}
            <strong>
              21./22. August 2027
            </strong>
            ?
          ...
          <p class="checkbox reset feedback">
            Schreibt mir wenn die Rollenspieltage 2027 wieder stattfinden.
          </p>
          <p class="checkbox reset feedback">
